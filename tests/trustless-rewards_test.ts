...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    assertEquals(
      tx.result,
      '(some {meta-data: {commission: u5, curves: "straight", description: "lobby description", factor: u5, hours: u24, length: "long", mapy: "miamiBeach", owner: ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5, traffic: "intense"}, values: {active: true, balance: u5, price: u5}})'
    );
  },
});
